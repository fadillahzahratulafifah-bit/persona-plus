...
export default function VendorChatPage() {
  ...
  const getPartnerName = (room: ChatRoom) => {
    ...
    return room.participantNames?.[partnerId] || "Pelanggan";
  };
        ...
        <div className="md:w-72 border-b md:border-b-0 md:border-r flex flex-col bg-muted/10 shrink-0 h-1/3 md:h-full">
          ...
          <div className="flex-1 overflow-y-auto">
            {loading ? (
              ...
              >
                <div className="w-11 h-11 rounded-full bg-accent/20 text-accent flex items-center justify-center font-bold text-base shrink-0">
          ...
          {activeRoom ? (
            <>
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-3">
                {messages.length === 0 && (
                  <div className="text-center text-sm text-muted-foreground py-8">Belum ada pesan. Mulai percakapan!</div>
                )}
                {messages.map(msg => {
              ...
              <div className="p-4 border-t bg-card space-y-2">
                ...
                <div className="flex gap-2 items-center">
                  ...
                  />
                  <Button onClick={handleSend} disabled={(!newMsg.trim() && !pendingImage) || sending} size="icon" className="rounded-full w-10 h-10 shrink-0">
            ...
            <div className="flex-1 flex items-center justify-center text-center p-8">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Pilih pelanggan di kiri untuk membaca atau membalas pesan.</p>
              </div>
            </div>
          )}
        </div>
